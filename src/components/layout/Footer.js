            ...
            {/* <div className="container-fluid"> */}
                <footer className="py-5">
                    <div className="row text-white mx-0">
                        <div className="col-2 text-white px-5">
                            <h5>Section</h5>
                    ...
                    <div className="d-flex justify-content-between py-4 my-4 border-top text-white px-5">
                        <p>&copy; 2021 Company, Inc. All rights reserved.</p>
                        <ul className="list-unstyled d-flex text-white">
                            <li className="ms-3"><Link className="link-dark text-white" to="#">Facebook icon</Link></li>
                            <li className="ms-3"><Link className="link-dark text-white" to="#">Twitter icon</Link></li>
                            <li className="ms-3"><Link className="link-dark text-white" to="#">Instagram icon</Link></li>
                        </ul>
                    </div>
                </footer>
            {/* </div> */}
